...
class WFirmaInvoiceStrategy(BaseInvoiceStrategy):
    ...
    def list_invoices(self):
        ...
        headers = {"accessKey": creds["access_key"], "secretKey": creds["secret_key"], "appKey": creds["app_key"]}
        data = requests.request("GET", "https://api2.wfirma.pl/invoices/find?outputFormat=json&inputFormat=json", headers=headers)
        print(data)
